...
export default function ProfileModal({ user, formulasCount, onClose, onLogout }: ProfileModalProps) {
  if (!user) return null;
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-center justify-between rounded-xl border border-slate-800 bg-slate-950/50 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-200">נוסחאות שמורות</div>
                  <div className="text-xs text-slate-400">נוסחאות באוסף האישי שלך</div>
                </div>
              </div>
