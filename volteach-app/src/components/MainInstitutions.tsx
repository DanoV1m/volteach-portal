      ...
      <div className="mx-auto grid max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {filtered.map((inst, idx) => (
          <div
            ...
            onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') onSelectInstitution(inst.key); }}
            role="button"
            tabIndex={0}
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-2" onClick={e => e.stopPropagation()} onKeyDown={e => e.stopPropagation()} role="presentation">
              {/* MOODLE LOGO */}
              <a
                href={inst.moodleUrl}
                target="_blank"
